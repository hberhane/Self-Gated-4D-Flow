...
for ind = 2:obj.options.ReVEALOpts.nit
    ...
    %Subsequent iterations have 10 inner loops
    ...
    meanB = abs(xhatGAMP_x.rhat);
    varB = pvarx;
    EstimIn_b1 = ncCAwgnEstimIn(meanB,varB);
    meanB = xhatGAMP_x.rhat;    
    ...
    meanX = abs(xhatGAMP_b.rhat);
    varX = pvarb;  
    EstimIn_x1 = ncCAwgnEstimIn(meanX,varX);
    meanX = xhatGAMP_b.rhat;
    ...
    meanY = abs(xhatGAMP_z.rhat);
    varY = pvarz;     
    EstimIn_y1 = ncCAwgnEstimIn(meanY,varY);
    meanY = xhatGAMP_z.rhat;
    ...
    meanZ =  abs(xhatGAMP_y.rhat);
    varZ = pvary;
    EstimIn_z1 = ncCAwgnEstimIn(meanZ,varZ);
    meanZ =  xhatGAMP_y.rhat;
