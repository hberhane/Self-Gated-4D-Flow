...
%**************************************************************************
    ...
    methods
        ...
        function obj = ReVEALOptions
            ...
            obj.ReVEALOpts.uniform_var = 1; % Use Uniform Variance Assumption
            ...
            obj.ReVEALOpts.precision = 'double'; % Use double or single precision
            obj.ReVEALOpts.data_size = 'large';
